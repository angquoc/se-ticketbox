  ...
  return (
    <div className="flex flex-col items-center justify-center pt-5 pb-5 flex-1 w-full">
      ...
      <div className="w-[130px] h-[130px] rounded-full bg-white flex items-center justify-center shadow-[0_8px_32px_rgba(0,0,0,0.08)] mb-7">
        <svg width="54" height="54" viewBox="0 0 24 24" fill="none" stroke="var(--color-error)" strokeWidth="4.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="w-full bg-white/12 backdrop-blur-[20px] border border-white/15 rounded-[20px] p-5 mb-10 box-border">
        ...
        <div className="flex flex-col gap-2 text-center">
          ...
          <span className="text-[15px] font-extrabold text-rose-200 leading-relaxed">
            {errorMsg}
          </span>
          <p className="text-[13px] font-medium text-white mt-3 mb-0 leading-relaxed bg-white/10 py-2.5 px-3.5 rounded-lg">
      ...
      <button
        onClick={onScanNext}
        className="w-full h-14 bg-white border-none rounded-2xl text-error text-[15px] font-bold tracking-wide flex items-center justify-center gap-2 cursor-pointer shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition-all duration-150 active:scale-95 hover:bg-white/95"
      >
        {/* Scan SVG icon */}
